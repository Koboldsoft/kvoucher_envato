...

    {
...

        {
            ...
            foreach ($required_data_company as $required) {
                ...
                if ( ( ! is_array( $company_data ) ) || @$company_data[$required] == null) {
            ...
            foreach ($required_data_paypal as $required) {
                ...
                if ( ( ! is_array( $paypal_data ) ) || @$paypal_data[$required] == null) {
        ...
        {
            $currency = self::kv_GetCurrencyPaypalHTMLoutput(); // load currency
