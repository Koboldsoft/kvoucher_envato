...
function kv_textfield_terms_of_service_callback()
{
    ...
    // Render the output
    echo '<textarea cols="90" rows="20" id="terms_of_service" name="kvoucher_plugin_terms_of_service_textfields[terms_of_service]" placeholder="your terms of service here">'.esc_textarea ($terms_of_service).'</textarea>';
}
