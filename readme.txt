...
1. Send voucher via PDF or via post
...
= 1.1.1 =
* fixes a bug in terms of services
* add a new language (French)

= 1.1.2 =
* fixes a bug in settings
* fixed a bug in mainpage

== Upgrade Notice ==

= 1.1.1 =
This version fixes a bug in terms of services

= 1.1.2 =
This version fixes a bug in settings and mainpage

== Installation ==
1. Upload "kvoucher.zip" to the "/wp-content/plugins/" directory.
2. Activate the plugin through the "Plugins" menu in WordPress.
3. enter your company contact details
4. insert your paypal client_id
5. Place shortcode "[kvoucher]" in your Wordpress page.

== Frequently Asked Questions ==
How it works?
Your customers data is encrypted and sent to an external server, where the PDF vouchers are created and sent. The data will not be saved.
